...
const Bored = () => {
    ...
    <div className="imgbox">
      ...
      <p>
        ...
        Connecting your friends through your phones and having playful sessions of online games in quarantine can also be very exciting. Online group gaming can be a great idea for the coming weekend.
      </p>
    ...
    <p>
      Another creative invention that allows playing your favorite casino games virtually. All types of casino games are available online, with short or as long as time the user wants. Online casino game developers try hard to recreate similar
      experience which is offered in typical casinos. Along with classic version of casino, several other formats are available online such as Slots, Roulette, Craps, Video Poker etc. They also have free versions, if you want to practice before you
      hit actually.
    ...
    <p>
      We are familiar with the board game version of codenames. Now, the developers have bought an online version of the same. It is a game of guessing, which are related to hint- words sets given by another player. So, two teams are made and on
      consecutive terms, the spymaster gives hint about words on both cards. After taking 30 seconds to set up, the game lasts for 15 minutes. And no matter, who wins or loses the laughter after the game is always memorable.
    </p>
  ...
  <div className="box">
    <div className="imgbox">
      ...
      <p>
        ...
        several
        other ways to pass your time in lockdown more effectively.Whether it be a new skill you have always wanted to learn, or an old hobby you’ve been meaning to pick back up again, now is the perfect time to busy yourself and make your time in
    ...
    <p>
      ...
      Whichever language you choose – whether it be French, Spanish, Mandarin or Swahili – it could make a big difference to your life once we finally get through the coronavirus outbreak.
    ...
    <p>
      Let’s set the scene.
      Your partner is doing a few odd jobs around the house to pass the time when you suddenly hear an almighty crash. You rush to see if they are OK, and you find them clutching their shoulder in pain on the floor. You help them as much as you can
      but are not really sure what to do. If only you had taken that course in first aid you’d been meaning to.
    ...
    <p>
      ...
      Gardening can not only be a highly therapeutic way of passing the time, but it can also feel incredibly rewarding when enjoying the literal fruits of your labour – whether it be tomatoes, carrots, chillis, peas, oranges, or whichever fruit or
      veg takes your fancy.
    ...
    <p>
      ...
      Whether you’d rather learn how to do something creative, like playing a musical instrument or becoming an artist, or something more exercise-focused, like how to do yoga or play table tennis, there are a ton of hobbies and activities out there
      to choose from.
  ...
  <div className="box">
    ...
    <div className="imgbox">
      ...
      <p>
        ...
        One
        thing which remains constant is how do we spend our time each and every day to avoid boredom from creeping in.One way of doing so is to revisit the games we used to play as children in school. We’ve selected a number of indoor games which you
        can
    ...
    <p>
      Physical activity and music- two essential items to survive this lockdown are part of this game. A favourite during birthday parties, participants walk around a bunch of chairs that have been placed while the music plays, and as soon as it
      stops
  ...
  <div className="box">
    ...
    <p>If isolation, anxiety, economic uncertainty, and the daily onslaught of bad news generated by the coronavirus pandemic are taking a heavy toll on your mood, you’re not alone. In the U.S., nearly half the respondents to a recent Kaiser Family
      Foundation poll felt the pandemic was harming their mental health—and that picture is repeated around the world. The stress of social isolation, the worry about jobs, money, and health, and the profound feelings of loss that many of us are
      experiencing at the moment can trigger depression for the first time or exacerbate symptoms if you’ve already been diagnosed.

      When you’re suffering from depression, life can seem overwhelmingly bleak and hopeless. It can interfere with your ability to think straight, drain your energy, and make it difficult to get through the day. Even as some countries and regions
      begin to ease stay-at-home restrictions, it seems unlikely that life will fully return to normal any time soon. But no matter what constraints you’re living under at the moment, these strategies can help you counteract loneliness, ease negative
    ...
    <div className="sidebar-box">
      <p>Experiencing a major change in your life, such the death of a loved one, the loss of a job, being diagnosed with a serious illness, or financial or relationship difficulties, can bring overwhelming levels of stress. As a result of this
        ...
        illness, or financial or relationship difficulties, can bring overwhelming levels of stress. As a result of this
  ...
  <div className="box">
    ...
    <div className="imgbox">
      ...
      <p>Without ignoring the realities we face, it is clear that the world is reaching for a positive message. These words were echoed by UN Secretary-General António Guterres to world leaders, as he emphasized the need for solidarity and global
        ...
        His call has resonated. Long sought-after partnerships with private sector companies are suddenly coming to fruition as everyone steps up to pitch in. UNDP has recently partnered with Variety on a global ad campaign. And UNDP’s new
        partnership with Heart17, a global initiative using creativity and innovation to accelerate the SDGs and light a spark of hope among the young generation, has brought together major players within fashion and popular culture, such as H&M
        Group and Spotify, to share their media space for messages around health and safety during the COVID-19 pandemic.</p>


        <p>

        Certainly there will be many lessons learned once COVID-19 has passed, and UNDP’s Accelerator Labs has assessed some of the post-COVID-19 trends they see emerging. A key takeaway is this: COVID-19 has been a sort of reset across societies,
        across sectors. From telecommuting for work or school, to supply chain management, to support for health systems, and small and medium enterprises, to mental health support across borders or simply across the street, COVID-19 has forced us to
        look at how we work as a species on this planet.
